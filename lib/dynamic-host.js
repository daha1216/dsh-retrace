      ...
      return {
        ...
        async writeMarker(session, span, meta) {
          if (typeof session.snapshotEvents === 'function') {
            const data = { id: editorId(meta.op), role: 'user', content: Array.isArray(meta.content) ? meta.content : [], source: { kind: 'plugin', plugin: 'retrace' }, editor: { targetSeq: meta.targetSeq, text: meta.originalText ?? '' }, shadowedSeqs: span.shadowedSeqs.slice() }
