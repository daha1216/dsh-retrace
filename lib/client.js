...
.dsh-rt-ghost{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:transparent;border:none;border-radius:6px;white-space:nowrap;padding:2px 6px;font-size:12px;line-height:20px}
.dsh-rt-ghost:hover:not(:disabled){color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-interactive-bg-hover)}
.dsh-rt-ghost:disabled{opacity:.5;cursor:default}
.dsh-rt-ghost-danger:hover:not(:disabled){color:var(--dsw-alias-state-error-primary)}
.dsh-rt-ghost-armed,.dsh-rt-ghost-armed:hover:not(:disabled){color:var(--dsw-alias-state-error-primary)}
.dsh-rt-ghost-armed:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}
