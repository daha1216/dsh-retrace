...
.dsh-rt-ghost{display:inline-flex;align-items:center;justify-content:center;color:var(--dsw-alias-label-secondary);cursor:pointer;background:var(--dsw-alias-interactive-bg-hover);border:none;border-radius:999px;white-space:nowrap;padding:2px 10px;font-size:12px;line-height:20px;font-weight:500;transition:background .15s ease,color .15s ease}
.dsh-rt-ghost:hover:not(:disabled){color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover-solid)}
.dsh-rt-ghost:disabled{opacity:.5;cursor:default}
.dsh-rt-ghost-danger:hover:not(:disabled){color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb,var(--dsw-alias-state-error-primary) 12%,var(--dsw-alias-interactive-bg-hover))}
.dsh-rt-ghost-armed,.dsh-rt-ghost-armed:hover:not(:disabled){color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb,var(--dsw-alias-state-error-primary) 15%,transparent);font-weight:600}
...
@keyframes dsh-rt-fade-in{from{opacity:0;transform:translateY(-3px)}to{opacity:1;transform:none}}
.dsh-rt-editor{display:flex;flex-direction:column;gap:8px;width:min(540px,85%);border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-elevated);border-radius:14px;padding:10px 14px 8px;box-shadow:var(--dsw-shadow-lv2,0 4px 16px rgba(0,0,0,.08));animation:dsh-rt-fade-in .15s ease-out;transition:border-color .15s ease,box-shadow .15s ease}
.dsh-rt-editor:focus-within{border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 1px var(--dsw-alias-state-business-primary),var(--dsw-shadow-lv2,0 4px 16px rgba(0,0,0,.08))}
.dsh-rt-textarea{resize:none;width:100%;box-sizing:border-box;color:var(--dsw-alias-label-primary);background:transparent;border:none;outline:none;padding:2px 2px;font:inherit;font-size:14px;line-height:1.55;letter-spacing:.1px;min-height:56px;max-height:360px;overflow-y:auto}
...
.dsh-rt-editor-send{display:inline-flex;align-items:center;justify-content:center;color:#fff;cursor:pointer;background:var(--dsw-alias-button-info-fill);border:none;border-radius:999px;padding:4px 16px;font-size:13px;line-height:20px;font-weight:500;box-shadow:0 1px 2px rgba(0,0,0,.1);transition:background .15s ease,box-shadow .15s ease,transform .1s ease,opacity .15s ease}
.dsh-rt-editor-send:hover:not(:disabled){background:var(--dsw-alias-button-info-hover);box-shadow:0 2px 5px rgba(0,0,0,.15)}
.dsh-rt-editor-send:active:not(:disabled){transform:scale(.98)}
.dsh-rt-editor-send:disabled{opacity:.4;cursor:default;box-shadow:none}
.dsh-rt-editor-cancel{display:inline-flex;align-items:center;justify-content:center;color:var(--dsw-alias-label-secondary);cursor:pointer;background:var(--dsw-alias-interactive-bg-hover);border:none;border-radius:999px;padding:4px 14px;font-size:13px;line-height:20px;font-weight:500;transition:background .15s ease,color .15s ease,transform .1s ease}
.dsh-rt-editor-cancel:hover:not(:disabled){color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover-solid)}
.dsh-rt-editor-cancel:active:not(:disabled){transform:scale(.98)}
.dsh-rt-editor-cancel:disabled{opacity:.4;cursor:default}
...
.dsh-rt-marker{position:relative;z-index:1;display:inline-flex;align-items:center;justify-content:center;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-base);border:1px solid var(--dsw-alias-border-l2);border-radius:999px;padding:2px 12px;font-size:11px;line-height:16px;font-weight:500;box-shadow:0 1px 2px rgba(0,0,0,.03);letter-spacing:.2px;transition:color .15s ease,border-color .15s ease}
.dsh-rt-marker:hover{color:var(--dsw-alias-label-secondary);border-color:var(--dsw-alias-border-l1)}
...
.dsh-rt-reference{width:min(540px,85%);box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);border-left:3px solid var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-elevated);border-radius:10px;padding:4px 12px;transition:border-color .15s ease,box-shadow .15s ease}
.dsh-rt-reference:hover{border-color:var(--dsw-alias-border-l1);border-left-color:var(--dsw-alias-state-business-primary)}
