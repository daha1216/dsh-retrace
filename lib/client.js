...
@keyframes dsh-rt-fade-in{from{opacity:0;transform:translateY(-4px) scale(.99)}to{opacity:1;transform:none}}
.dsh-rt-editor{display:flex;flex-direction:column;gap:10px;width:min(540px,85%);background:color-mix(in srgb,var(--dsw-alias-bg-elevated) 70%,transparent);backdrop-filter:blur(24px) saturate(180%);-webkit-backdrop-filter:blur(24px) saturate(180%);border:1px solid color-mix(in srgb,var(--dsw-alias-border-l1) 30%,rgba(255,255,255,.24));border-radius:18px;padding:12px 16px 10px;box-shadow:0 12px 32px rgba(0,0,0,.08),0 2px 6px rgba(0,0,0,.03),inset 0 1px 1px 0 rgba(255,255,255,.35);animation:dsh-rt-fade-in .2s cubic-bezier(0.16,1,0.3,1);transition:border-color .2s ease,box-shadow .2s ease,background .2s ease}
.dsh-rt-editor:focus-within{border-color:color-mix(in srgb,var(--dsw-alias-state-business-primary) 80%,rgba(255,255,255,.5));box-shadow:0 0 0 1px var(--dsw-alias-state-business-primary),0 14px 38px rgba(0,0,0,.12),0 0 16px color-mix(in srgb,var(--dsw-alias-state-business-primary) 30%,transparent),inset 0 1px 1px 0 rgba(255,255,255,.45)}
.dsh-rt-textarea{resize:none;width:100%;box-sizing:border-box;color:var(--dsw-alias-label-primary);background:transparent;border:none;outline:none;padding:2px 0;font:inherit;font-size:14px;line-height:1.55;letter-spacing:.1px;min-height:56px;max-height:360px;overflow-y:auto}
...
.dsh-rt-editor-send{display:inline-flex;align-items:center;justify-content:center;color:#fff;cursor:pointer;background:linear-gradient(180deg,color-mix(in srgb,var(--dsw-alias-button-info-fill) 88%,#fff) 0%,var(--dsw-alias-button-info-fill) 100%);border:1px solid rgba(255,255,255,.2);border-radius:999px;padding:5px 18px;font-size:13px;line-height:18px;font-weight:500;letter-spacing:.2px;box-shadow:0 2px 8px color-mix(in srgb,var(--dsw-alias-button-info-fill) 35%,transparent),inset 0 1px 0 rgba(255,255,255,.3);transition:all .18s cubic-bezier(0.16,1,0.3,1)}
.dsh-rt-editor-send:hover:not(:disabled){transform:translateY(-1px);box-shadow:0 4px 12px color-mix(in srgb,var(--dsw-alias-button-info-fill) 45%,transparent),inset 0 1px 0 rgba(255,255,255,.4)}
.dsh-rt-editor-send:active:not(:disabled){transform:scale(.96)}
.dsh-rt-editor-send:disabled{opacity:.4;cursor:default;box-shadow:none;transform:none}
.dsh-rt-editor-cancel{display:inline-flex;align-items:center;justify-content:center;color:var(--dsw-alias-label-secondary);cursor:pointer;background:color-mix(in srgb,var(--dsw-alias-interactive-bg-hover) 65%,transparent);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);border:1px solid color-mix(in srgb,var(--dsw-alias-border-l2) 45%,rgba(255,255,255,.18));border-radius:999px;padding:5px 16px;font-size:13px;line-height:18px;font-weight:500;box-shadow:0 1px 2px rgba(0,0,0,.02),inset 0 1px 0 rgba(255,255,255,.2);transition:all .18s cubic-bezier(0.16,1,0.3,1)}
.dsh-rt-editor-cancel:hover:not(:disabled){color:var(--dsw-alias-label-primary);background:color-mix(in srgb,var(--dsw-alias-interactive-bg-hover-solid) 80%,transparent);border-color:var(--dsw-alias-border-l1);transform:translateY(-1px);box-shadow:0 2px 6px rgba(0,0,0,.05),inset 0 1px 0 rgba(255,255,255,.3)}
.dsh-rt-editor-cancel:active:not(:disabled){transform:scale(.96)}
