...
.dsh-rt-editor{display:flex;flex-direction:column;gap:10px;width:min(540px,85%);background:color-mix(in srgb,var(--dsw-alias-bg-elevated) 46%,transparent);backdrop-filter:blur(20px) saturate(190%);-webkit-backdrop-filter:blur(20px) saturate(190%);border:1px solid color-mix(in srgb,var(--dsw-alias-border-l2) 45%,rgba(255,255,255,.32));border-radius:16px;padding:12px 14px 10px;box-shadow:0 8px 28px rgba(0,0,0,.06),0 1px 3px rgba(0,0,0,.02),inset 0 1px 1px 0 rgba(255,255,255,.4);animation:dsh-rt-fade-in .2s cubic-bezier(0.16,1,0.3,1);transition:border-color .2s ease,box-shadow .2s ease,background .2s ease}
.dsh-rt-editor:focus-within{background:color-mix(in srgb,var(--dsw-alias-bg-elevated) 56%,transparent);border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 0 1px var(--dsw-alias-state-business-primary),0 12px 34px rgba(0,0,0,.08),inset 0 1px 1px 0 rgba(255,255,255,.5)}
...
.dsh-rt-editor-cancel{display:inline-flex;align-items:center;justify-content:center;color:var(--dsw-alias-label-secondary);cursor:pointer;background:color-mix(in srgb,var(--dsw-alias-interactive-bg-hover) 45%,transparent);backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);border:1px solid color-mix(in srgb,var(--dsw-alias-border-l2) 40%,rgba(255,255,255,.18));border-radius:999px;padding:5px 16px;font-size:13px;line-height:18px;font-weight:500;box-shadow:0 1px 2px rgba(0,0,0,.02),inset 0 1px 0 rgba(255,255,255,.2);transition:all .18s cubic-bezier(0.16,1,0.3,1)}
.dsh-rt-editor-cancel:hover:not(:disabled){color:var(--dsw-alias-label-primary);background:color-mix(in srgb,var(--dsw-alias-interactive-bg-hover-solid) 75%,transparent);border-color:var(--dsw-alias-border-l1);transform:translateY(-1px);box-shadow:0 2px 6px rgba(0,0,0,.05),inset 0 1px 0 rgba(255,255,255,.3)}
