...
.dsh-rt-editor{display:flex;flex-direction:column;gap:8px;width:min(540px,85%);border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-elevated);border-radius:14px;padding:10px 12px;box-shadow:var(--dsw-shadow-lv2,0 4px 16px rgba(0,0,0,.08));animation:dsh-rt-fade-in .15s ease-out;transition:border-color .15s ease,box-shadow .15s ease}
...
.dsh-rt-textarea{resize:vertical;width:100%;box-sizing:border-box;color:var(--dsw-alias-label-primary);background:transparent;border:none;outline:none;padding:2px 4px;font:inherit;font-size:14px;line-height:22px;min-height:64px}
